...
<body>
	...
	<c:forEach items="${examList}" var="exam">
		<tr>
		<td><input type="radio" id="ExamIdToRemoveRadio" name="ExamIdToRemoveRadio" value="<c:out value="${exam.examId}"/>"/>
		<td><c:out value="${exam.examId}"></c:out></td>
        ...
        <td>
            ...
            if(Usersession.getAttribute("ExamCreationError")!= null)
             out.print(Usersession.getAttribute("ExamCreationError")); %></b><br/>
              <input class="submit" type="image" src="${pageContext.request.contextPath}/images/Remove-Exam.png"  
