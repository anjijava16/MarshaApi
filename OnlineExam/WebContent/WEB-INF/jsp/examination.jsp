...
//if(AlottedTime == null) 
AlottedTime = UserSession.getAttribute("DURATION").toString();
...
<title><% out.print(UserSession.getAttribute("EXAMID")+" : "+UserSession.getAttribute("UEID")); %> - Online Examination Portal</title>
    </head>
    <body>
...
<div id="ExamPageHeader" style="height: 10%; width:100%; position: fixed; top: 0;left: 0; padding-top: 5px; padding-bottom: 12px; background-color: #e1e1f0">
            ...
            <table border="0" width="600"  cellspacing="0" cellpadding="2">
                ...
                <tr align="center">
                    <td rowspan="2">
                        <b style="font-size: 24px"> <% out.print(UserSession.getAttribute("EXAMID")); %> </b>
                    </td>
                </tr>
